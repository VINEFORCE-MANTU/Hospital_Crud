...
namespace UserCrud.Migrations
{
    ...
    [Migration("20260319071143_AddAdmissionApprovalStatusInPatientAdmission")]
    partial class AddAdmissionApprovalStatusInPatientAdmission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserCrud.PatientAdmission.patientAdmission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("UserCrud.PatientImages.patienttImages", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("patienttImages");
                });

            modelBuilder.Entity("UserCrud.Patients.patient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("UserCrud.Rooms.room", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("UserCrud.PatientAdmission.patientAdmission", b =>
                {
                    b.HasOne("UserCrud.Beds.bed", "Bed")
                        .WithMany()
                        .HasForeignKey("BedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserCrud.Docters.doctor", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserCrud.Patients.patient", "Patient")
                        .WithMany()
